...
mcp = FastMCP(
    name="Fractale Gateway",
    instructions="This server provides tools for high performance computing workloads.",
    website_url="https://github.com/compspec/fractale",
...
auth_token = os.environ.get("FRACTALE_MCP_TOKEN")
auth = None
if auth_token:
